...
const SERVICES: ServiceCategory[] = [
  {
    ...
    services: [
      ...
      { name: "Basic Pedicure", price: "$40", description: "Exfoliation, mask, and extended massage." },
      { name: "Gel X", price: "$65", description: "Strong, durable, and lightweight finish." }
    ]
  },
  {
    title: "Pedicure Services",
    services: [
      { name: "Deluxe Pedicure", price: "$65", description: "Sea salt soak, shape, cuticle care, and polish." },
      { name: "Gel Pedicure", price: "$50", description: "Callus removal, sugar scrub, and mud mask." },
      { name: "Organic Spa Pedicure", price: "$65", description: "Premium organic products and hot stone massage." },
      { name: "Pedicure Add-on", price: "+$15", description: "Upgrade any pedicure to gel polish." }
    ]
  },
  {
  ...
  return (
    <section id="home" className="relative h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <img 
          src="https://lh3.googleusercontent.com/NTapZGiYSv41mJfYH2or4K1lY7tmuIEo2tSScibsxSmF7d-d2UM49b-NvJB_vnULly4GdxyW_o4IWq2BNg=s360-w360-h360" 
          alt="Nail Salon Hero" 
    ...
    <footer id="contact" className="bg-dark-soft pt-24 pb-12 border-t border-white/5">
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid lg:grid-cols-3 gap-16 mb-20">
          {/* Contact Info */}
          <div>
            <h2 className="text-3xl font-serif text-gold mb-8">All Perfect Nails</h2>
            <div className="space-y-6">
